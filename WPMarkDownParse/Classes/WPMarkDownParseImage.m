...
- (void)setAttributedString:(NSMutableAttributedString *)attributedString{
    ...
    CGFloat fontSize = [WPSettingConfigSharedManager sharedManager].fontSize;
    [self.segmentArray enumerateObjectsUsingBlock:^(WPMarkDownParseLinkModel * _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
        ...
        {   /*
             ...
             */
            UIImageView * imageView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, ScreenWidth-16*2, (ScreenWidth-16*2)*0.68)];
...
- (WPMutableParagraphStyleModel *)paragraphStyleModel:(CGFloat)width{
    ...
    styleModel.headIndent = (ScreenWidth-width)/2-16;//整体缩进(首行除外)
    styleModel.firstLineHeadIndent = (ScreenWidth-width)/2-16;
    return styleModel;
}
